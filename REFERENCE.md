...
<details>
  ...
  |----------|----------------|-------|
  | `data/FreeBSD.yaml` | `facts.os.family`: `FreeBSD` | `true` |
...
<details>
  ...
  | Filename | Interpolations | Value |
  |----------|----------------|-------|
  | `data/RedHat.RedHat.6.yaml` | `facts.os.family`: `RedHat`<br>`facts.os.name`: `RedHat`<br>`facts.os.release.major`: `6` | `true` |
  | `data/RedHat.CentOS.6.yaml` | `facts.os.family`: `RedHat`<br>`facts.os.name`: `CentOS`<br>`facts.os.release.major`: `6` | `true` |
  | `data/RedHat.OracleLinux.6.yaml` | `facts.os.family`: `RedHat`<br>`facts.os.name`: `OracleLinux`<br>`facts.os.release.major`: `6` | `true` |
...
<details>
  ...
  | Filename | Interpolations | Value |
  |----------|----------------|-------|
  | `data/FreeBSD.yaml` | `facts.os.family`: `FreeBSD` | `open-vm-tools-nox11` |
...
<details>
  ...
  | Filename | Interpolations | Value |
  |----------|----------------|-------|
  | `data/Debian.yaml` | `facts.os.family`: `Debian` | `false` |
...
<details>
  ...
  | Filename | Interpolations | Value |
  |----------|----------------|-------|
  | `data/Debian.yaml` | `facts.os.family`: `Debian` | `open-vm-tools` |
  | `data/FreeBSD.yaml` | `facts.os.family`: `FreeBSD` | `vmware_guestd` |
